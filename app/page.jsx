...
const CTA = () => {
  return (
    <div className="flex flex-col items-center gap-2 py-15 pb-40 relative border border-b-neutral-200">
...
const Footer = () => {
   <div className="flex flex-col items-center gap-2 py-15 pb-15 relative border-b border-b-neutral-200">
      <div className="text-5xl font-medium text-center font-display">Are you an AI company? <br />Feature your tool</div>
      <div className="mt-5 text-center text-lg text-neutral-500 w-xl">Get updates on the newest AI tools and industry insights delivered to your inbox.</div>
      <div className="mt-5 flex items-center gap-2">
        {/* <Input placeholder="Enter your email" className="bg-neutral-100 w-sm py-6 rounded-3xl px-5 placeholder:text-base" /> */}
        <button className="cursor-pointer rounded-3xl bg-black text-white font-medium text-base p-3 px-4 w-fit">Submit your product</button>
      </div>
